...
class ColorPickerDialog private constructor(
    ...
    class Builder(val activity: Activity) {
        private var title: String = activity.getString(R.string.material_dialog_title)
        private var positiveButton: String =
            activity.getString(R.string.material_dialog_positive_button)
        private var negativeButton: String =
            activity.getString(R.string.material_dialog_negative_button)
        ...
        fun setPositiveButton(@StringRes text: Int): Builder {
            this.positiveButton = activity.getString(text)
            return this
        }
        ...
        fun setNegativeButton(@StringRes text: Int): Builder {
            this.negativeButton = activity.getString(text)
            return this
        }
    ...
    fun show() {
        ...
        val initialColor = if (!defaultColor.isNullOrBlank()) {
            ...
            ContextCompat.getColor(activity, R.color.grey_500)
        }
        ...
        recentColorsRV.layoutManager = FlexboxLayoutManager(activity)
