...
object AppRating {
    ...
    fun getLaunchTimes(context: Context) = PreferenceUtil.getLaunchTimes(context)
    fun increaseLaunchTimes(context: Context) = PreferenceUtil.increaseLaunchTimes(context)
    ...
    data class Builder(var activity: AppCompatActivity) {
        ...
        internal constructor(activity: AppCompatActivity, dialogOptions: DialogOptions) : this(
            activity) {
